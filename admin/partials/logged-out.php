...
<div class="ecf-text-center">
    <img src="<?php echo plugins_url('/admin/img/logo-compact.svg', EMAILCHEF_ADD_ON_FOR_PMP_PATH); ?>" class="ecf-login-logo" alt="">
</div>
<form action="<?php echo admin_url('options.php'); ?>" method="post" class="ecf-login-form" id="ecf-login-form">
    ...
    <p class="ecf-text-center ecf-login-form-signup">
		<?php
		echo sprintf(__('Not a member? <a target="_blank" href="%s">Sign up for free.</a>', 'emailchef-add-on-for-pmp'), "https://app.emailchef.com/apps/demo/quicksignup");
		?>
    </p>
    ...
    <fieldset>
        ...
        <div class="ecf-login-form-control-group">
            ...
            <label for="consumer_key" class="ecf-login-form-get-api">
				<?php _e('Consumer Key', 'emailchef-add-on-for-pmp'); ?>:
        ...
        <div class="ecf-text-center">
            ...
            <input type="button" id="ecf-login-submit" class="button button-primary"
                   value="<?php _e('Login', 'emailchef-add-on-for-pmp'); ?>">
